...
console.log(post);
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-green-600 text-lg font-medium rounded-full text-blue px-8 py-3 cursor-pointer">Continue à lire</span>
      </Link>
    </div>
        </div>
    )
